        ...
        {pages.map((pageItems, idx) => (
          <div key={idx} className="bill-page">
            ...
            <div style={{ textAlign: 'center', marginBottom: '15px', position: 'relative', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
              <img src="/logo.png" alt="Logo" className="print:block print:max-w-[100px]" style={{ position: 'absolute', top: '0', left: '-8px', height: '50px', width: 'auto', objectFit: 'contain', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }} />
