            ...
            <div className="bg-card-bg border border-border-default rounded shadow-sm p-5 bg-gradient-to-br from-surface to-surface-bg">
              <div className="flex flex-col gap-3">
                ...
                {billType === 'DPL' && totals.litre_discount_total > 0 && (
                  <div className="flex justify-between items-center text-sm text-text-muted animate-in fade-in pb-2">
        ...
        {pages.map((pageItems, idx) => (
          <div key={idx} className="bill-page">
            ...
            <div style={{ textAlign: 'center', marginBottom: '15px', position: 'relative', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
              <img src="/logo.png" alt="Logo" className="print:block print:max-w-[100px]" style={{ position: 'absolute', top: '0', left: '-24px', height: '50px', width: 'auto', objectFit: 'contain', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }} />
